...
public class PostResponseAsyncTask extends AsyncTask<String,Void,String> {
    ...
    //Constructor
    public PostResponseAsyncTask(Context context,boolean showLoadingMessage,
    ...
    public PostResponseAsyncTask(Context context,HashMap<String, String> postData,
                                 AsyncResponse asyncResponse){
        this.context = context;
    ...
    public PostResponseAsyncTask(Context context,HashMap<String, String> postData,String loadingMessage,
                                 AsyncResponse asyncResponse){
        this.context = context;
        this.postData = postData;
        this.loadingMessage = loadingMessage;
