...
public class PostCheckAsyncTask extends AsyncTask<String,Void,String> {
    ...
    //Constructor
    public PostCheckAsyncTask(Context context,AsyncResponse asyncResponse){
        this.asyncResponse = asyncResponse;
        this.context = (View.OnClickListener) context;
    }

    //Constructor
    public PostCheckAsyncTask(Context context,boolean showLoadingMessage,
                                 AsyncResponse asyncResponse ){
        this.asyncResponse = asyncResponse;
        this.context = (View.OnClickListener) context;
    }

    public PostCheckAsyncTask(Context context,HashMap<String, String> postData,
                                 AsyncResponse asyncResponse){
        this.context = (View.OnClickListener) context;
    ...
    public PostCheckAsyncTask(Context context,HashMap<String, String> postData,
                                 boolean showLoadingMessage,AsyncResponse asyncResponse){
        this.context = (View.OnClickListener) context;
        this.postData = postData;
        this.asyncResponse = asyncResponse;
    }

    public PostCheckAsyncTask(View.OnClickListener context, HashMap<String, String> loadingMessage, AsyncResponse asyncResponse){
        this.context = (View.OnClickListener) context;

        this.asyncResponse = asyncResponse;
    }

    public PostCheckAsyncTask(Context context, HashMap<String, String> postData, HashMap<String,
                              AsyncResponse> asyncResponse){
        this.context = (View.OnClickListener) context;
        this.postData = postData;
    }
    ...
    //Setter and Getter
    public void setLoadingMessage(HashMap<String, String> loadingMessage) {
    }
    ...
    public View.OnClickListener getContext() {
        return context;
    }
    ...
    protected String doInBackground(String... strings) {
        String result = "";
        for(int i = 0; i <= 0; i++){
            result = invokePost(strings[i], postData);
        }
        return result;
    }
